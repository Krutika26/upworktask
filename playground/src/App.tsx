...
function App() {
  ...
  return (
    ...
    >
      ...
      >
        <button type="button" onClick={() => locale.setLang('vi')}>Hindi</button>
        <button type="button" onClick={() => locale.setLang('en')}>English</button>
        <button type="button" onClick={() => locale.setLang('zh_CN')}>French</button>
        ...
        <button type="button" onClick={() => locale.setLang('hu_HU')}>German</button>
        <button type="button" onClick={() => locale.setLang('hu_HU')}>Italian</button>
